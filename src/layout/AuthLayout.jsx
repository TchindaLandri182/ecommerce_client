...
const AuthLayout = ({children}) => {
    return (
        <section style={{minHeight: 650, maxHeight: 800}} className="md:h-[calc(100vh-6rem)] flex items-center justify-center">
            <div style={{maxWidth: 1300, maxHeight: 620}} className="flex flex-col md:flex-row w-full h-full m-5 rounded-3xl overflow-hidden">
                ...
                <div className="w-full md:w-1/2 md:h-full md:flex hidden">
